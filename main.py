...
tk_calc = Tk()
tk_calc.configure(bg="#3C3636", bd=12)
...
text_display = Entry(tk_calc, font=('sans-serif', 20, 'bold'), textvariable=text_input,
                     bd=5, insertwidth = 4, bg='#BBB', justify='right', width=22).grid(columnspan=5, padx = 12, pady = 24)
# text_display = Entry(tk_calc, font=('sans-serif', 20, 'bold'), textvariable=text_input,
#                      bd=5, insertwidth=4, bg='#BBB', justify='right', width=10)

button_params = {'bd':10, 'fg':'#BBB', 'bg':'#3C3636', 'font':('sans-serif', 12, 'bold')}
button_params_main = {'bd':5, 'fg':'#BBB', 'bg':'#3C3636', 'font':('sans-serif', 12, 'bold')}
...
delete_one = Button(tk_calc, bd=5, fg='#BBB', font=('sans-serif', 12, 'bold'),
              text='DEL', command=button_delete, bg='#3C3636').grid(row=6, column=3, sticky="nsew")
delete_all = Button(tk_calc, bd=5, fg='#BBB', font=('sans-serif', 12, 'bold'),
              text='AC', command=button_clear_all, bg='#3C3636').grid(row=6, column=4, sticky="nsew")
...
equal = Button(tk_calc, button_params_main, text='=',font=('sans-serif', 16, 'bold'),
